...
var data = {
  ...
  tracks: [createTrack("deeppink", Tom1(audio)),
           createTrack("purple", Tom2(audio)),
           createTrack("aqua", Tom3(audio)),
           createTrack("green", Crash1(audio)),
           createTrack("gold", Crash2(audio)),
           createTrack("orange", Hats(audio)),
           createTrack("red", snare(audio)),
...
document.getElementById("tempobox").disabled = true;
    ...
    clearInterval(myVar);
      ...
      document.getElementById("tempobox").disabled = false;
...
(function draw() {
  ...
  drawButton(screen, data.step, data.tracks.length, "lightgreen");
...
function kick(audio) {
  ...
  // var vol=(document.getElementById("Kickvolv").value;
  // document.getElementById("Kick").volume = 0.1;
    // console.log(document.getElementById("Kick").volume);

  return function() { kick.play(),document.getElementById("Kick").currentTime = 0};


};

// **snare()** plays a kick drum sound for `1` second.
function snare(audio) {
  return function() { document.getElementById("Snare").play(),document.getElementById("Snare").currentTime = 0};
};
// **hats()** plays a kick drum sound for `1` second.
function Hats(audio) {
  return function() { document.getElementById("Hats").play(),document.getElementById("Hats").currentTime = 0};
};

// **Crash1()** plays a kick drum sound for `1` second.
function Crash1(audio) {
  return function() { document.getElementById("Crash_1").play(),document.getElementById("Crash_1").currentTime = 0};
};

// **Crash2()** plays a kick drum sound for `1` second.
function Crash2(audio) {
  return function() { document.getElementById("Crash_2").play(),document.getElementById("Crash_2").currentTime = 0};
};

// **Tom1()** plays a kick drum sound for `1` second.
function Tom1(audio) {
  return function() { document.getElementById("Tom_1").play(),document.getElementById("Tom_1").currentTime = 0};
};
// **Crash2()** plays a kick drum sound for `1` second.
function Tom2(audio) {
  return function() { document.getElementById("Tom2").play(),document.getElementById("Tom2").currentTime = 0 };
};
// **Crash2()** plays a kick drum sound for `1` second.
function Tom3(audio) {
  return function() { document.getElementById("Tom3").play(),document.getElementById("Tom3").currentTime = 0};
};
